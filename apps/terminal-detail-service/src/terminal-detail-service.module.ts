...
import { TerminalDetailController } from './terminal-detail-service.controller';
...
@Module({
  imports: [
    ConfigModule.forRoot({
      envFilePath: 'apps/terminal-detail-service/.env.dev',
  ...
  controllers: [TerminalDetailController],
  providers: [TerminalDetailService, TerminalService],
})
export class TerminalDetailServiceModule {}
